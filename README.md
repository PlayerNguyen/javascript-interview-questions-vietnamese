# Câu hỏi & Trả lời Phỏng vấn JavaScript

> Dự án này được xây dựng bởi [@SudheerJonna](https://twitter.com/SudheerJonna).

Đi đến [Coding Exercise](#coding-exercise) để xem các bài tập code cụ thể. Bạn nên tham khảo những khái niệm cơ bản của JavaScript như object, prototype,... trước khi đến với bài viết này để có một cách tổng quan nhất về bài học mà chúng ta sẽ tiếp thu.

Đôi lời từ người dịch: Bài viết này được tạm dịch để tiếp cận với nhiều người Việt Nam nhất có thể, nên sẽ có sai sót không mong muốn ở một số nội dụng. Nếu bạn muốn đóng góp cho bài viết này để giúp nâng cao trinh học JavaScript cho mọi người thì hãy cứ tự nhiên, bằng cách tạo một pull request để mình xem xét và đưa lên cho bạn nhé :star:

## Tải về dưới dạng PDF/Epub

Bạn cũng có thể tải về dưới dạng PDF hoặc Epub bằng cách truy cập vào đây[actions tab](https://github.com/sudheerj/JavaScript-Interview-Questions/actions)
...
1. ### Có bao nhiêu cách để tạo ra objects trong JavaScript

   Chúng ta có những cách sau để tạo ra object trong JavaScript

   1. **Object constructor (tạm dịch: hàm tạo object):**

      <!-- The simplest way to create an empty object is using the Object constructor. Currently this approach is not recommended. -->

      Đây là cách đơn giản nhất để tạo ra một object rỗng bằng cách sử dụng constructor (hàm tạo). Hiện tại thì cách tiếp cận này không được phổ biến và khuyên dùng.

      ```javascript
      var object = new Object();
      ```

   2. **Object's create method (phương pháp Object.create):**

      <!-- The create method of Object creates a new object by passing the prototype object as a parameter -->

      Phương pháp Object.create tạo ra một object mới bằng cách truyền một prototype object (object nguyên mẫu) vào biến truyền (parameter).

      ```javascript
      var object = Object.create(null);
      ```

   3. **Object literal syntax (tạm dịch: ...):**

       <!-- The object literal syntax (or object initializer), is a comma-separated set of name-value pairs wrapped in curly braces. -->

      Object literal syntax (hay object khởi tạo), là một tập các cặp tên-giá trị, được ngăn cách bằng dấu phẩy, và bao bọc trong dấu ngoặc móc.
   ...
   6. **ES6 Class syntax:**
      ...
      ES6 cũng giới thiệu tính năng class để tạo ra một object mới
